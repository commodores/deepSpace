...
public class RobotMap {
  ...
  public static final double kP = 0.185;        // Start with P = 10% of your max output, double until you get a quarter-decay oscillation
	public static final double kI = .0025;           // Start with I = P / 100
	public static final double kD = 5;           // Start with D = P * 10
